...
**Goal:** Build agent-fleet into a public Steward Agent control plane that can supervise Worker Agents across projects, sessions, worktrees, and remote execution nodes.
